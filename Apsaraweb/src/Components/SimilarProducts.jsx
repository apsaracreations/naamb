        ...
        <div className="container mx-auto px-6">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-600">
              A selection of the best Collection.
            </p>
          </div>
          ...
          <div className="flex justify-center mt-10">
            <button
              ...
              className="px-8 py-3 bg-[#310000dc] cursor-pointer text-white rounded-full font-semibold tracking-wider shadow-lg hover:bg-[#3c0808] hover:scale-105 transition transform duration-300"
            >
              See All Products
            </button>
          </div>
